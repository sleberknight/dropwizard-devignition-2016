...
import com.devignition.service.DevIgnitionConfiguration;
...
public class SpringTestConfiguration {
    ...
    @Bean
    public DevIgnitionConfiguration devIgnitionConfiguration() {
        ...
        ConfigurationFactory<DevIgnitionConfiguration> factory =
                new ConfigurationFactory<>(DevIgnitionConfiguration.class, validator, objectMapper, "dw");
    ...
    @Bean
    public SpeakerDao speakerDao() throws Exception {
        ...
        return dbi.onDemand(SpeakerDao.class);
    }
